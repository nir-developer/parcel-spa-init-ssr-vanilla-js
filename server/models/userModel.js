...
userSchema.pre("save", function (next) {
  ...
  console.log(
    "pre-save M.W - updated passwordChangedAt : ",
...
userSchema.methods.changedPasswordAfter = function (JWTTimeStamp) {
  if (this.passwordChangedAt) {
    ...
    console.log(
      `password updated: ${changedTimestamp}`,
      `JWT ISSUED AT: ${JWTTimeStamp}`,
    );
    console.log(
      `PASSWORD CHANGED AFTER JWT ISSUED? ${JWTTimeStamp < changedTimestamp}`,
    );
